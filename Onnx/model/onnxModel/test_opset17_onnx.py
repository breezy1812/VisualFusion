...
output_path = "/circ330/forgithub/VisualFusion_libtorch/Onnx/model/onnxModel/zopset17_fp16.onnx"
...
cv2.imwrite("/circ330/forgithub/VisualFusion_libtorch/Onnx/model/onnxModel/testonnox.jpg", img)
print('img writed!')
